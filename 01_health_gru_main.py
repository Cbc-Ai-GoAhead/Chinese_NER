...
from package.model import BiLSTM_CRF, BiLSTM_CRF_01_dropout, GRU_CRF
...
if mode == 'Train':
    ...
    #Create Model
    model = GRU_CRF(len(dataset_train.id2tag),lstm_hidden_dim=lstm_hidden_dim,lstm_dropout_rate=lstm_dropout_rate).to(device)
